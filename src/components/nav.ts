...
const navTiles: NavTileConfig[] = [
  {
    ...
    label: "🎊 Plushie Party Invite! 🎉 (FSC 2026)",
  ...
  {
    name: "dsts-viewer",
    href: "https://nuffle.me/dsts-viewer/",
    image: cdn("site/logo/dsts.png"),
    eventName: "nav.dsts-viewer",
    label: "Digimon Story: Time Stranger - Model Viewer",
  },
  {
    name: "Tangled",
    href: "https://tangled.org/nuffle.me",
    image: cdn("site/logo/tangled.jpeg"),
    eventName: "nav.tangled",
    label: "@nuffle.me on Tangled",
  },
  {
    name: "Ko-fi",
    href: "https://ko-fi.com/nuffle",
    image: cdn("site/logo/kofi.png"),
    eventName: "nav.ko-fi",
    label: "nuffle on Ko-fi",
    addDivider: true,
  },
  // {
